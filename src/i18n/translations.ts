...
export const translations = {
    ...
    en: {
      ...
      experience: {
        ...
        items: [
          ...
          },
          {
            ...
            location: 'Seoul',
            description: 'Co-founded DeepLeHR and managed the development team as CTO, leading frontend development throughout the entire process from initial MVP to service launch and maintenance. Focused on enhancing user experience and building scalable systems, contributing to HR solution development.',
            technologies: [
              'React',
              'Next.js',
              'Zustand',
          ...
          },
          {
            ...
            description: 'Participated in the Strategic Planning Department through POSTECH\'s Summer Internship Program (SES). Conducted various data analysis and market research tasks, contributing to strategy development.',
            technologies: [],
          },
        ],
      },
        ...
        items: [
          {
            ...
            description: 'Handled full development and deployment of Credittalk, a voice phishing prevention application, as a freelance project.',
          },
          {
            name: 'MonoTouch',
            organization: 'POSTECH',
            period: 'Feb 2020 – Jun 2020',
            description: 'Developed in the Creative Design course for IT Convergence Engineering major. A smartphone accessibility app enabling one-handed operation, built using Java.',
          },
          {
            name: 'Sensing the City : Arduino',
            organization: 'Rhode Island School of Design',
            period: 'Jun 2017 – Aug 2017',
            description: 'Final project as RISD exchange student. Responsible for product design and Arduino software development.',
          },
          {
      ...
      languages: {
        ...
        items: [
          ...
          {
            language: 'Chinese',
            level: 'Intermediate (Limited working proficiency)',
      ...
      contact: {
        title: 'Contact',
        description: 'Open to discussing new projects or collaboration opportunities. Feel free to reach out.',
      },
      nav: {
        home: 'Home',
        blog: 'Blog',
    ...
    zh: {
      ...
      experience: {
        ...
        items: [
          ...
          },
          {
            ...
            location: '首尔',
            description: '共同创立DeepLeHR，作为CTO管理开发团队并主导前端开发，涵盖从初期MVP到服务上线及运维的全过程。专注于提升用户体验和构建可扩展系统，为HR解决方案开发做出贡献。',
            technologies: [
              'React',
              'Next.js',
              'Zustand',
          ...
          },
          {
            ...
            location: '首尔江南区',
            description: '通过POSTECH暑期实习项目(SES)加入战略规划部门。执行各类数据分析和市场调研工作，为战略制定提供支持。',
            technologies: [],
          },
        ],
      },
      ...
      projects: {
        ...
        items: [
          {
            name: 'Credittalk应用开发',
            organization: '韩国金融消费者联合会 & KAIST',
            period: '2025年5月 – 2025年9月',
            description: '作为外包项目，负责语音钓鱼预防应用Credittalk的完整开发和部署流程。',
          },
          {
            name: 'MonoTouch',
            organization: 'POSTECH',
            period: '2020年2月 – 2020年6月',
            description: 'IT融合工程专业创意设计课程项目。一款支持单手操作智能手机的无障碍应用，使用Java开发。',
          },
          {
            name: 'Sensing the City : Arduino',
            organization: '罗德岛设计学院',
            period: '2017年6月 – 2017年8月',
            description: 'RISD交换生结业项目。负责产品设计和Arduino软件开发。',
          },
          {
            name: '视障人士智能手杖开发',
            organization: '庆南科学高中',
            period: '2015年3月 – 2016年9月',
            description: '高中R&E项目。负责产品设计、Arduino软件开发和成果展示。',
          },
        ],
      },
      awards: {
    ...
    ja: {
      ...
      experience: {
        ...
        items: [
          ...
          },
          {
            ...
            period: '2020年3月 – 2025年1月',
            location: 'ソウル',
            description: 'DeepLeHRを共同創業し、CTOとして開発チームを管理。初期MVPからサービスローンチ、運用保守まで全過程でフロントエンド開発をリード。ユーザー体験の向上とスケーラブルなシステム構築に注力し、HRソリューション開発に貢献。',
            technologies: [
              'React',
              'Next.js',
              'Zustand',
          ...
          },
          {
            ...
            period: '2019年6月 – 2019年9月',
            location: 'ソウル江南区',
            description: 'POSTECHの夏季インターンシッププログラム(SES)を通じて戦略企画室に参加。各種データ分析と市場調査業務を実施し、戦略策定に貢献。',
            technologies: [],
          },
        ],
      },
        ...
        items: [
          {
            ...
            organization: '韓国金融消費者連合 & KAIST',
            period: '2025年5月 – 2025年9月',
            description: 'フリーランスプロジェクトとして、ボイスフィッシング防止アプリCredittalkの開発からデプロイまで全工程を担当。',
          },
          {
            name: 'MonoTouch',
            organization: 'POSTECH',
            period: '2020年2月 – 2020年6月',
            description: 'IT融合工学専攻の創意設計授業で制作。片手でスマートフォンを操作できるアクセシビリティアプリ。Javaで開発。',
          },
          {
            name: 'Sensing the City : Arduino',
            organization: 'ロードアイランド・スクール・オブ・デザイン',
            period: '2017年6月 – 2017年8月',
            description: 'RISD交換留学の最終プロジェクト。プロダクトデザインとArduinoソフトウェア開発を担当。',
          },
          {
            name: '視覚障害者向けスマート杖開発',
            organization: '慶南科学高校',
            period: '2015年3月 – 2016年9月',
            description: '高校R&Eプログラムプロジェクト。製品設計、Arduinoソフトウェア開発、成果発表を担当。',
          },
        ],
      },
      awards: {
        ...
        items: [
          {
            ...
            issuer: 'World Quant',
            year: '2025年7月',
            description: 'World Quant IQC全国選手権5位入賞',
          },
          {
            name: 'POSTECHハッカソン3位',
            issuer: 'POSTECH PoApper',
            year: '2018年10月',
            description: 'POSTECH PoApperハッカソン3位入賞',
          },
          {
            name: 'ISEF出場',
      ...
      contact: {
        title: 'お問い合わせ',
        description: '新しいプロジェクトやコラボレーションの機会について、お気軽にご連絡ください。',
      },
      nav: {
        home: 'ホーム',
        blog: 'ブログ',
